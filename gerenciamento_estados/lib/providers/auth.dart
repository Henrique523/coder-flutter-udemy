...
import 'package:gerenciamento_estados/data/store.dart';
...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(String email, String password, String urlFragment) async {
    final url = 'https://identitytoolkit.googleapis.com/v1/accounts:$urlFragment?key=AIzaSyCstRjftAEf92lsPlwIep5T8xzdL0yx_58';
  ...
  Future<void> tryAutoLogin() async {
    ...
    final expiresDate = DateTime.parse(userData['expiresIn']);
  ...
  void logout() {
    ...
    _clearLogoutTimer();
    Store.clear().then((_) => notifyListeners());
  }
